...
const Navbar = ({ isDark, toggleTheme }: NavbarProps) => {
  ...
  return (
    <>
      <nav
        className={`fixed top-0 w-full py-4 z-50 transition-all duration-300 transform-gpu ${isScrolled
          ? "bg-white/65 dark:bg-[#050505]/65 backdrop-blur-lg md:backdrop-blur-xl border-b border-black/10 dark:border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.4)]"
          : "bg-white/40 dark:bg-[#050505]/40 md:bg-transparent md:dark:bg-transparent backdrop-blur-md md:backdrop-blur-none border-b border-transparent"
          }`}
      >
