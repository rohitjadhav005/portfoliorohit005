            ...
            >
              <div className="bg-white/80 dark:bg-[#111111]/80 backdrop-blur-xl border border-black/10 dark:border-white/10 rounded-[24px] p-6 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative">
                <button 
                  ...
                  className="absolute top-4 right-4 md:top-6 md:right-6 w-10 h-10 flex items-center justify-center rounded-full bg-white/60 dark:bg-[#1a1a1a] text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors"
